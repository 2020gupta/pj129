...
time.sleep(10)
headers = ["Brown_dwarf", "Constellation", "Right_ascension", "Declination", "Distance", "Spectral_type", "Mass", "Radius","Discovery_year"]
planet_data = []
new_planet_data = []
def scrape():
    for i in range(1, 430):
        while True:
            ...
            if current_page_num < i:
                ...
                break
        for ul_tag in soup.find_all("ul", attrs={"class", "dwarfplanet"}):
